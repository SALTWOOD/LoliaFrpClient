...
namespace LoliaFrpClient.Core.User.Tunnel.Item
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static new global::LoliaFrpClient.Core.User.Tunnel.Item.WithTunnel_nameResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::LoliaFrpClient.Core.User.Tunnel.Item.WithTunnel_nameResponse();
        }
    }
}
